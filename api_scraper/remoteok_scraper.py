...
def output_jobs_to_xls(data):
    ...
    # Trả về hết tất cả key trong data[0] điền vào đầu mỗi cột trong excel: 
    # ['slug', 'id', 'epoch', 'date', 'company',...]
...
if __name__ == "__main__":
    ...
    send_email('Enter Sending Email Here', 
               ['contact@preneure.com'],
               'Jobs Posting', 
               'Please, find attached a list of job posting to this email',
